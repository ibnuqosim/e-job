...
<table class="jobdes" border="1">
    ...
    <tr>
        <td colspan="7">
            <table width="100%">
                <tr class="isi">
                    <td width="40%">Bertanggung jawab langsung kepada :<br>(Directly Responsible to)</td>
    ...
    <tr>
        <td colspan="7">
            <table width="100%">
                <tr class="isi">
                    <td width="40%">Jabatan yang diawasi langsung :<br>(Direct Supervised positions)</td>
                    <td>
                            <ul>
                                @foreach ($job as $koor)
    ...
    @endforeach
    <tr>
        <td colspan="4" class="isi">Melaksanakan setiap tugas dan tanggung jawab dengan memerhatikan aspek dan kondisi keuangan
    ...
    <tr>
        <td colspan="4" class="isi">Melaksanakan tugas sesuai dengan Sistem Manajemen Krakatau Steel (SMKS) dan peraturan/kebijakan
    ...
    <tr>
        <td colspan="7">
            <table width="100%">
                <tr class="isi">
                    <td width="30%">Finansial (Financial)</td><td align="center" width="2%">:</td>
                    <td>{{$data[0]->finansial}}</td>
                </tr>
                <tr class="isi">
                    <td width="30%">Non Finansial (Financial)</td><td align="center" width="2%">:</td>
    ...
    <tr>
        <td colspan="7">
            <table class="jobdes" border="1">
            <tr>
                <td class="subjudul" width="50%" align="center"><b>Unit Kerja<br>(Work Unit)</b></td><td class="subjudul" width="50%" align="center"><b>Dalam Hal<br>(In Terms of)</b></td>
            </tr>
            <tr>
                <td class="isi">a. Internal :<br>(Internal)<ul>
                        @foreach ($unit as $junit)
                        {{"- ".$junit->id_emp_cskt_ltext}}
                        @endforeach
                    </ul>
                    
                    </td><td class="isi">@foreach ($unit as $junit)
                            {{"- ".$junit->id_hal_internal}}
                            @endforeach</td>
            </tr>
            <tr>
                <td class="isi">b. Eksternal :<br>(External)
                    <ul>
    ...
    <tr>
        <td colspan="7" class="isi">
                <table width="100%">
                    <tr class="isi">
                        <td width="15%">1.Alat Kerja<br> (Tools)</td><td align="center" width="2%">:</td>
                        <td>@foreach ($tools as $jtools)
                                {{"-".$jtools->id_deskripsi}}
                                @endforeach</td>
                    </tr>
                    <tr class="isi">
                        <td width="15%">2.Bahan Kerja<br> (Materials)</td><td align="center" width="2%">:</td>
                        <td>@foreach ($mat as $jmat)
                                {{"-".$jmat->id_deskripsi}}
                                @endforeach</td>
                    </tr>
                    <tr class="isi">
                        <td width="15%">3.Lingk. Kerja<br> (Conditions)</td><td align="center" width="2%">:</td>
    ...
    <tr>
        ...
        <tr>
                <td colspan="7" class="isi">
                        <table width="100%">
                            <tr class="isi">
                                <td width="20%">1.Pendidikan dan Pengalaman Kerja<br> (Education & Work Experience)</td><td align="center" width="2%">:</td>
                                <td> <ul>
                                        @foreach ($pen as $jpen)
                                        <li>{{$jpen->id_jenjang}}
                            ...
                            <tr class="isi">
                                <td width="20%">2.Persyaratan Fisik<br> (Physical Requirements)</td><td align="center" width="2%">:</td>
                                <td><ul>
                            ...
                            <tr class="isi">
                                    <td width="20%">3.Profil Jabatan<br> (Job Profile)</td><td align="center" width="2%">:</td>
            ...
            <tr>
                <td colspan="7"><img src="{{ storage_path('app/'.$data[0]->gambar) }}" height="300" width="600"/></td>
            </tr>
            <tr>
                <td colspan="7" class="subjudul"><b>X. LEGALISASI (Legalization)</b></td>
            </tr>
            <tr>
                <td colspan="3" class="isi" align="center">DIANALISIS OLEH:<br>(Analyzed By)</td><td colspan="4" class="isi" align="center">MENYETUJUI<br>(Approved By)</td>
            </tr>
            <tr>
                <td colspan="3" class="isi" align="center"><br><br><br>@if($data[0]->approveanalis==1)<p><b>APPROVED</b></p>@endif<br>{{$data[0]->analis}}</td><td  class="isi" align="center"><br><br><br>@if($data[0]->approveuser==1)<p><b>APPROVED</b></p>@endif<br>{{$data[0]->namauser}}</td><td colspan="3" class="isi" align="center"><br><br><br>@if($data[0]->approveodhcp==1)<p><b>APPROVED</b></p>@endif<br>{{$data[0]->approve}}</td>
            </tr>
            <tr>
                <td colspan="3" class="isi" align="center">{{$data[0]->jabanalis}}</td><td class="isi" align="center">{{$data[0]->jabuser}}</td><td colspan="3" class="isi" align="center">{{$data[0]->jabapprove}}</td>
            </tr>
            <tr>
                <td colspan="3" class="isi">TGL(Date): {{$data[0]->tglapproveanalis}}</td><td class="isi" align="center">TGL(Date):{{$data[0]->tglapproveuser}}</td><td colspan="3" class="isi" align="center">TGL(Date):{{$data[0]->tglapproveodhcp}}</td>
            </tr>
</table>
        ...
        <tr>
            ...
            <td width="33%" align="right">
                <table frame="box" width="100%">
                    <tr class="isiprofil"><td>No. Issue</td><td>:</td><td></td></tr>
                    <tr class="isiprofil"><td>No. RS</td><td>:</td><td>RS/PO00/010</td></tr>
                    <tr class="isiprofil"><td>Tgl.</td><td>:</td><td>{{date("d/m/Y")}}</td></tr>
                </table>
            </td>
        </tr>
</table>
<table class="jobdes" border="1">
    <tr>
        <td width="50%">
            <table>
                <tr class="isiprofil"><td>NAMA POSISI</td><td>:</td><td><b>{{$profil[0]->namajabatan}}</b></td></tr>
                <tr class="isiprofil"><td>GOLONGAN</td><td>:</td><td><b>{{$profil[0]->golongan}}</b></td></tr>
                <tr class="isiprofil"><td>NO. JABATAN</td><td>:</td><td><b>{{$profil[0]->nojabatan}}</b></td></tr>
            </table>
        </td>
        <td  width="50%">
                <table>
                    <tr class="isiprofil"><td>ABREVIATION NO.</td><td>:</td><td><b>{{$profil[0]->noorg}}</b></td></tr>
                    <tr class="isiprofil"><td>UNIT KERJA</td><td>:</td><td><b>{{$profil[0]->unitkerja}}</b></td></tr>
                    <tr class="isiprofil"><td>JOB GROUP</td><td>:</td><td><b>{{$profil[0]->jobgroup}}</b></td></tr>
                </table>
