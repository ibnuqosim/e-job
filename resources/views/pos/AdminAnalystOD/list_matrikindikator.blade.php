                    ...
                    <?php $no=0; ?>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                {{-- <a class="glyphicon glyphicon-pencil" href="{{ url('AdminAnalystOD/editmatrikindikator',['id'=>$item->id]) }}">edit</a> --}}
                                {{-- <a class="glyphicon glyphicon-trash" data-target="#modal-info" href="{{ url('AdminAnalystOD/deletematrikindikator',['id'=>$item->id]) }}"></a> --}}
                        ...
                        <div class="modal modal-info fade" id="modal-info{{ $item->id }}">
                            <div class="modal-dialog">
                                ...
                                <div class="modal-body">
                                    <form action="{{ url('AdminAnalystOD/editmatrikindikator/'.$item->id) }}" method="get" >
                        ...
                        <div class="modal modal-info fade" id="modal-delete{{ $item->id }}">
                            <div class="modal-dialog">
                                ...
                                <div class="modal-body">
                                    <form action="{{ url('AdminAnalystOD/deletematrikindikator/'.$item->id) }}" method="get">
                                        <button type="submit" class="btn btn-sm btn-success">OK</button>
                                        <button type="button" class="btn btn-sm btn-danger" data-dismiss="modal">Close</button>
                                    </form>
                                </div>
