...
<section class="content">
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title">Title Pengalaman Kerja</h3>
            
            <div class="box-footer">
                <a class="btn btn-primary" href="{{ url('AdminAnalystOD/fromAddpengalamankerja') }}">Tambah</a>
            </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="glyphicon glyphicon-trash" data-target="#modal-info" href="{{ url('AdminAnalystOD/deletepengalamankerja',['id'=>$item->id])}}"></a> --}}
                        ...
                        <div class="modal modal-info fade" id="modal-info{{ $item->id }}">
                            <div class="modal-dialog">
                                ...
                                <div class="modal-body">
                                    <form action="{{ url('AdminAnalystOD/editpengalamankerja/'.$item->id) }}" method="get">
                        ...
                        <div class="modal modal-info fade" id="modal-delete{{ $item->id }}">
                            <div class="modal-dialog">
                                ...
                                <div class="modal-body">
                                    <form action="{{ url('AdminAnalystOD/deletepengalamankerja/'.$item->id) }}" method="get">
                                        <button type="submit" class="btn btn-sm btn-success">OK</button>
                                        <button type="button" class="btn btn-sm btn-danger" data-dismiss="modal">Close</button>
                                    </form>
                                </div>
